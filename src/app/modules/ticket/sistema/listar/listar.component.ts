...
import { SistemaModel } from '../../../../shared/models/ticket/SistemaModel';
...
export class ListarComponent extends CrudForm<SistemaModel> implements OnInit {
  // SÓ PRECISA SETAR ESSAS INFORMAÇÃO
  registro: SistemaModel = {};


  constructor(
    protected fb: FormBuilder,
    protected service: SistemaService,  // SETAR O SERVICE QUE IRÁ TRABALHAR
